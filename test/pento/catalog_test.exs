defmodule Pento.CatalogTest do
  ...
  describe "products" do
    ...
    test "markdown_product/1 decreases product unit_price" do
      product = product_fixture()

      assert %Ecto.Changeset{valid?: false} =
               Catalog.markdown_product(product, %{unit_price: 1_000})

      assert %Ecto.Changeset{valid?: true} = Catalog.markdown_product(product, %{unit_price: 1})
    end
  end
end
